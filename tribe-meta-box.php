 ...
 * @author Matt Wiebe for Shane & Peter, Inc.
...
class Tribe_Meta_Box {
	...
	function register_scripts_and_styles() {
		...
		wp_register_style( 'tribe-meta-box', $base_url . '/resources/meta-box.css');
		wp_register_script('tribe-meta-box', $base_url . '/resources/meta-box.js', array('jquery'), null, true);
